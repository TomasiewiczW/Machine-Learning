...
from Lab7_process_email import process_email
from Lab7_email_features import email_features
...
file_contents = read_file('Lab7_data/emailSample1.txt')
...
X_train = np.genfromtxt('Lab7_data/spamTrain_X.csv', delimiter=',')
y_train = np.genfromtxt('Lab7_data/spamTrain_y.csv', delimiter=',')
...
# Load the test dataset ('Lab7_data/spamTest_X.csv', 'Lab7_data/spamTest_y.csv').
# You will have Xtest, ytest in your environment
X_test = np.genfromtxt('Lab7_data/spamTest_X.csv', delimiter=',')
y_test = np.genfromtxt('Lab7_data/spamTest_y.csv', delimiter=',')
...
filename = 'Lab7_data/spamSample1.txt'
